...
public class UserActivityServiceTest {
    ...
    private UserActivityDTO montarDtoOK() {
        ...
        dtoOK.setScore(123L);
        dtoOK.setSubmittedAtS("aaa");
        dtoOK.setStatus("aa");
        dtoOK.setUserName("aaa");
        dtoOK.setUserId(UUID.randomUUID());
        dtoOK.setActivityType("aaa");
        dtoOK.setModuleDescription("aaa");
        return dtoOK;
    }
    ...
    private UserActivityDTO montarDtoOkLimite() {
        ...
        dtoLimite.setUserId(UUID.randomUUID());
    ...
    private Activity montarActivity() {
    ...
    private br.com.impacta.bootcamp.formacao.model.Module montarModule() {

        br.com.impacta.bootcamp.formacao.model.Module module = new Module();
        module.setIndex(1L);
    ...
    public  void setup() {
        ...
        Mockito.when(activityService.findByIdInterno(Mockito.any())).thenReturn(montarActivity());
    }
    ...
    public void tentarSalvarErroRepetido() {
        ...
        userActivity.setUser(montarUser());
        userActivity.setModule(montarModule());
        userActivity.setActivity(montarActivity());
